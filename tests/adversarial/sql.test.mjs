...
const DENY = [
  ...
  ["TRUNCATE users", "TRUNCATE without TABLE"],
  ["DROP INDEX ix_users", "DROP INDEX"],
  ["DROP VIEW users_v", "DROP VIEW"],
  ...
  ['SELECT "pg_sleep"(10)', "quoted pg_sleep"],
  ['SELECT pg_catalog."lo_unlink"(12345)', "quoted schema-qualified lo_unlink"],
  ["SELECT \"setval\"('some_sequence',1)", "quoted setval"],

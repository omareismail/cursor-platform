...
or just producing more code faster. It runs `.cursor/tools/delivery-metrics.mjs`
...
This workspace is 99 skills of throughput amplification. That is exactly the
...
node .cursor/tools/delivery-metrics.mjs report --deploy-tag 'v*'
# the team's actual incident/hotfix convention
node .cursor/tools/delivery-metrics.mjs report --fix-pattern '\b(hotfix|INC-[0-9]+)\b'
```

...
- `.cursor/rules/06-database-provider-guard.mdc` (primary)
- `.cursor/rules/07-audit-trail-guard.mdc`
- `memory-bank/databaseConventions.md`, `architecture.md`,
  `performanceGuidelines.md`, `businessRules.md`
- `.cursor/skills/database-audit/skill.md`,
  `.cursor/skills/dotnet-schema-diff/skill.md`,
  `.cursor/skills/dotnet-query-optimizer/skill.md`,
  `.cursor/skills/dotnet-migration/skill.md`

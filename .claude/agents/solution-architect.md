...
|---|---|
| "What shape is this system?" | `.cursor/skills/solution-architecture/skill.md` |
| "What are the endpoints?" | `.cursor/skills/api-contract-design/skill.md` |
| "How is it stored?" | `.cursor/skills/data-model-design/skill.md` |
| "What could an attacker do?" | `.cursor/skills/threat-model/skill.md` |
| "Record the decision" | `.cursor/skills/speckit-adr/skill.md` |

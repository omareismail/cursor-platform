...
|---|---|
| "What are the entities?" | `.cursor/skills/domain-model-gen/skill.md` |
| "How does the business actually flow?" | `.cursor/skills/use-case-gen/skill.md` |
| "What rules constrain this?" | `.cursor/skills/business-rules-gen/skill.md` |
| "What could make this fail?" | `.cursor/skills/risk-register/skill.md` |
...
node .cursor/tools/lifecycle.mjs check ANALYSIS
```

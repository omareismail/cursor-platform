...
|---|---|
| "Is this ready to ship?" | `.cursor/skills/production-readiness-review/skill.md` |
| "What should we monitor / alert on?" | `.cursor/skills/operability-gen/skill.md` |
| "How do we roll this out safely?" | `.cursor/skills/release-safety/skill.md` |
| "Is delivery getting better or worse?" | `.cursor/skills/delivery-metrics/skill.md` |
| "Build the CI/CD pipeline" | `.cursor/skills/deployment-pipeline-gen/skill.md` |
| "Plan and run the cutover" | `.cursor/skills/go-live/skill.md` |
| "Is phase 6 done?" | `.cursor/lifecycle/gates/06-production.gate.md` |

## Always start here

```bash
node .cursor/tools/feature-map.mjs show <feature-id>    # what the thing does
node .cursor/tools/delivery-metrics.mjs report --days 90

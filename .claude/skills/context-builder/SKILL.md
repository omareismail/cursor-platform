...
description: "context-builder is distinct from both existing foundational skills, not a restatement of either: Invoked as /context-builder."
---

# context-builder

> **Registration shim.** Canonical instructions live in
> `.cursor/skills/context-builder/skill.md` - single source of truth, shared with Cursor.
...
1. **Read `.cursor/skills/context-builder/skill.md` now** and follow every step literally.
2. Apply the platform contract in `AGENTS.md`:
   - **Category:** D (housekeeping) - run silently, no announcement
   - Announcement (unless Category D): `**Matched skill:** context-builder - [one-line description].`

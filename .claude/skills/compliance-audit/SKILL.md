...
> `.cursor/skills/compliance-audit/skill.md` - single source of truth, shared with Cursor.
...
1. **Read `.cursor/skills/compliance-audit/skill.md` now** and follow every step literally.
2. Apply the platform contract in `AGENTS.md`:
   - **Category:** B (read-only analysis) - announce, then proceed
   - Announcement (unless Category D): `**Matched skill:** compliance-audit - [one-line description].`

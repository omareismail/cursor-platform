---
name: enterprise-report-gen
description: "Assembles a standardized executive-facing report by aggregating existing audit skills' output into one consistent template. Report types: architecture, security, performance, database, repository-health, technical-debt, production-readiness, release-readiness, dependency-health, code-quality. Use when asked for a readiness, health or status report for management. Invoked as /enterprise-report-gen."
---

# enterprise-report-gen

> **Registration shim.** Canonical instructions live in
> `.cursor/skills/enterprise-report-gen/skill.md` - single source of truth, shared with Cursor.
...
1. **Read `.cursor/skills/enterprise-report-gen/skill.md` now** and follow every step literally.
2. Apply the platform contract in `AGENTS.md`:
   - **Category:** A (generates/modifies files) - announce, then wait for go-ahead
   - Announcement (unless Category D): `**Matched skill:** enterprise-report-gen - [one-line description].`

...
description: "release-notes-gen generates customer-facing release notes in plain language with zero implementation detail — separate from the developer-focused changelog-gen output. The audience is end users, product stakeholders, and customer success teams. Invoked as /release-notes-gen."
---

# release-notes-gen

> **Registration shim.** Canonical instructions live in
> `.cursor/skills/release-notes-gen/skill.md` - single source of truth, shared with Cursor.

...
> `.cursor/skills/dashboard/skill.md` - single source of truth, shared with Cursor.
...
1. **Read `.cursor/skills/dashboard/skill.md` now** and follow every step literally.
2. Apply the platform contract in `AGENTS.md`:
   - **Category:** C (docs/diagrams) - announce, then proceed
   - Announcement (unless Category D): `**Matched skill:** dashboard - [one-line description].`

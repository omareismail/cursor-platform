...
description: "Audits an already-shipped .NET API surface for cross-endpoint consistency - route naming, versioning, DTO shape, pagination, error/ProblemDetails format, auth attribute placement and OpenAPI annotations across endpoints written at different times by different people. Use when asked whether the API is consistent, or to review the whole API surface rather than one endpoint. Invoked as /api-consistency-audit."
---

# api-consistency-audit

> **Registration shim.** Canonical instructions live in
> `.cursor/skills/api-consistency-audit/skill.md` - single source of truth, shared with Cursor.

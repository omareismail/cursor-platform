...
**Memory references:** `${CLAUDE_PLUGIN_ROOT}/docs/skill-graph.md` (the declared
dependency contract this audit checks skills against), every
`${CLAUDE_PLUGIN_ROOT}/skills/*/SKILL.md` file in scope.

...
description: "speckit-clarify converts the Open Questions list from speckit-analyze into a structured Q&A record where every question is presented as 2-4 labeled options with trade-offs and a clear recommendation — never an open blank. It enforces the elicitation protocol defined in 05-planning-rigor.mdc, scaling question count to feature complexity. Invoked as /speckit-clarify."
---

<!-- GENERATED from the cursor-platform source skill "speckit-clarify".
...
the elicitation protocol defined in `${CLAUDE_PLUGIN_ROOT}/rules/05-planning-rigor.mdc`,

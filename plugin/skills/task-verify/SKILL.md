...
<!-- GENERATED from the cursor-platform source skill "task-verify".
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/tools/task-graph.mjs next specs/plans/<slug>-tasks.md
node ${CLAUDE_PLUGIN_ROOT}/tools/ac-trace.mjs matrix specs/features/<slug>.md
```

---
name: platform-health-validator
description: "Workspace-hygiene check over the whole cursor-platform install: verifies rules, skills, docs and memory-bank are internally consistent, cross-references resolve, and nothing has drifted out of sync. Use when asked whether the platform itself is healthy or correctly wired. Invoked as /platform-health-validator."
---

<!-- GENERATED from the cursor-platform source skill "platform-health-validator".
...
- All 99 skills: correctly kebab-cased ✓

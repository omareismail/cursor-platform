...
<!-- GENERATED from the cursor-platform source skill "speckit-git-initialize".
...
See `${CLAUDE_PLUGIN_ROOT}/rules/01-specify-rules.mdc` for the full pipeline documentation.
```

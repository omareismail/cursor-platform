...
<!-- GENERATED from the cursor-platform source skill "deployment-pipeline-gen".
...
| Docs and platform | `node ${CLAUDE_PLUGIN_ROOT}/tools/docs-lint.mjs check`, `node ${CLAUDE_PLUGIN_ROOT}/tools/flag-debt.mjs scan` |
| Lifecycle gate | `node ${CLAUDE_PLUGIN_ROOT}/tools/lifecycle.mjs check` for the current phase |
